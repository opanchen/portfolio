...
export const IconLink: React.FC<IconLinkProps> = ({
  ...
  const footerClassNames =
    'aspect-square flex items-center justify-center p-[8px] rounded-md shadow dark:shadow-white-shadow bg-white-primary text-gray-primary dark:bg-black-secondary dark:text-white-primary hover:scale-110 focus:scale-110 transition_prop';
